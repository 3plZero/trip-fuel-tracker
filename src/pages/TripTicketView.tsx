  ...
  return (
    <div className="space-y-6">
      ...
      <div className="print-only hidden text-center mb-6">
        <h1 className="text-xl font-bold">Department of Science and Technology</h1>
        <h2 className="text-lg">Cordillera Administrative Region</h2>
        <h3 className="text-lg font-bold mt-4">VEHICLE TRIP TICKET</h3>
      </div>
